<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registracion.aspx.cs" Inherits="WillHoliday.Registracion" %>
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" Text="Submit" runat="server" OnClick="RegistrarUsuario" />
            </td>
            <td>
            </td>
        </tr>
